...
mixin ApplicationLayerConstraints on LayerBoundaryEnforcement {
  ...
  List<ArchitecturalLayer> get allowedDependencies => [
    ...
    ArchitecturalLayer.application, // Can depend on other application components
  ];
}
...
mixin InfrastructureLayerConstraints on LayerBoundaryEnforcement {
  ...
  @override
  List<ArchitecturalLayer> get allowedDependencies => [
    ArchitecturalLayer.domain, // Can depend on domain (implements interfaces)
...
mixin PresentationLayerConstraints on LayerBoundaryEnforcement {
  ...
  @override
  List<ArchitecturalLayer> get allowedDependencies => [
    ArchitecturalLayer.domain, // Can depend on domain (entities, value objects)
    ArchitecturalLayer.application, // Can depend on application (use cases)
    ArchitecturalLayer.presentation, // Can depend on other presentation components
  ];
}
