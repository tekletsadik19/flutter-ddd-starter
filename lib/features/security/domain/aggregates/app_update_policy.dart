...
class UpdateRequirement extends Equatable {
  ...
  bool get isForced => priority == UpdatePriority.required || priority == UpdatePriority.critical;
...
class AppUpdatePolicy extends Equatable {
  ...
  bool get isCurrentVersionSupported => currentVersion.isCompatibleWith(minimumSupportedVersion);
  ...
  static bool _hasSecurityUpdates(List<String> releaseNotes) {
    ...
    return releaseNotes.any((note) =>
        securityKeywords.any((keyword) =>
