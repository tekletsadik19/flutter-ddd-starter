  ...
  group('Hive Migration with SHA-256 Security', () {
    ...
    group('EncryptionService', () {
      ...
      test('should hash and verify data integrity', () {
        ...
        expect(EncryptionService.verifyDataIntegrity('modified_data', hash), isFalse);
      });
    });
    ...
    group('CacheManager with Hive', () {
      ...
      test('should handle complex data types', () async {
        ...
        await cacheManager.store(key, data);
        final retrieved = await cacheManager.retrieve<Map<String, dynamic>>(key);
    ...
    group('SecureStorage with Hive', () {
      ...
      test('should store and retrieve secure data with integrity check', () async {
    ...
    group('HiveEncryptionManager', () {
      ...
      test('should create secure box configurations', () {
        final cacheConfig = encryptionManager.createSecureBoxConfig('test_cache');
        final secureConfig = encryptionManager.createSecureBoxConfig('test_secure', isSecure: true);
